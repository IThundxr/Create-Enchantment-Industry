...
public class CeiFluids {
    ...
    public static final ResourceLocation EXPERIENCE_STILL_RL = EnchantmentIndustry.asResource("fluid/experience_still");
    public static final ResourceLocation EXPERIENCE_FLOW_RL = EnchantmentIndustry.asResource("fluid/experience_flow");
    ...
    public static final ResourceLocation HYPER_EXPERIENCE_STILL_RL = EnchantmentIndustry.asResource("fluid/hyper_experience_still");
    public static final ResourceLocation HYPER_EXPERIENCE_FLOW_RL = EnchantmentIndustry.asResource("fluid/hyper_experience_flow");
    ...
    public static final ResourceLocation INK_STILL_RL = EnchantmentIndustry.asResource("fluid/ink_still");
    public static final ResourceLocation INK_FLOW_RL = EnchantmentIndustry.asResource("fluid/ink_flow");
